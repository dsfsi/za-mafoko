...
The files on [https://github.com/dsfsi/za-marito/](https://github.com/dsfsi/za-marito/) are under [CC-BY-SA-4.0](https://github.com/dsfsi/za-marito/blob/master/data/oertb/LICENSE) and should acknowledge the Original OERTB + _Open Database_ authors list.
